...
public class tokenRing {
    public static void main(String[] args) {
        ...
        System.out.println("Enter the number of jode you want in ring :");
        int n = sc.nextInt();
        ...
        do {
            ...
            for (int i = sender + 1; i != receiver; i = (i + 1) % n) {
                System.out.println("Data Forworded by " + i);
            }
            System.out.println("Receiver " + receiver + "received data " + data);
            token = sender;
            System.out.println("Toen is now at node " + token);
        } while (choice == 1);
        // Scanner sc = new Scanner(System.in);
        ...
        // System.out.println("Sender " + sender + " sending data: " + data); // Sender
        // sending data
        // for (int i = (sender + 1) % n; i != receiver; i = (i + 1) % n) {
        // System.out.println("Data forwarded by " + i); // Data forwarded by
        // intermediate nodes
        // }
        // System.out.println("Receiver " + receiver + " received data: " + data); //
        // Receiver receiving data
        // token = sender; // Update token position
        // System.out.println("Token is now at node: " + token); // Token position
        // updated
